...
function NFT001() {
  ...
  const tokenId =
    "20380798278448505662861399834612724564619233566642749688288578972500793229313";
  const copyHandler = () => {
        ...
        <div className="w-full md:max-w-1/2 mx-auto">
          <div className="flex flex-col space-y-8">
            <div className="font-bold text-center">
              SOUL NFT HEADPHONE
              <br />
              <span className="text-4xl">#002</span>
            </div>
            <img
              width="772"
              src="https://cdn.shopify.com/s/files/1/0276/0176/4435/files/SOUL_NFT_headphone__002.png?v=1634714712"
              alt="Headphone NFT 002"
              className="mx-auto"
            />
            ...
            <div>
              ...
              customized headphone designed upon request of the MAYC #1933
              current holder.
              <br />
              <br />
              Inspired by the MAYC #1933’s psychedelic, daredevil appetite for
              risk, SOULNATION designed a wicked sick mosaic pattern wrapped
